...
export default function Main(){
    ...
    return(
        <main className="mt-2 mb-2">
            <form action={handleClick} className="border-2 flex justify-center pt-5 pb-5 gap-4">
                <input 
            ...
            <div className="border-2 max-w-190 mx-auto">
            ...
            <div className="max-w-190 rounded-md mt-4 p-5 flex justify-between items-center bg-[#cecdc8]">
                ...
                <button onClick={getRecipe} className="bg-orange-400 px-4 py-2 text-white font-semibold rounded-md cursor-pointer hover:bg-amber-600">Get a recipe</button>
